...
const image_client_1 = __webpack_require__(99);
const weather_client_1 = __webpack_require__(820);
class BaseCard {
    constructor(parent) {
        var _a, _b;
...
const until_js_1 = __webpack_require__(345);
const utils_1 = __webpack_require__(593);
...
const lit_1 = __webpack_require__(677);
const directive_js_1 = __webpack_require__(82);
const custom_card_helpers_1 = __webpack_require__(197);
...
const formulaone_card_types_1 = __webpack_require__(98);
let FormulaOneCardEditor = class FormulaOneCardEditor extends lit_1.LitElement {
    setConfig(config) {
        this.config = config;
    }
    get _cardType() {
        var _a;
        return ((_a = this.config) === null || _a === void 0 ? void 0 : _a.card_type) || '';
    }
    get _title() {
        var _a;
        return ((_a = this.config) === null || _a === void 0 ? void 0 : _a.title) || null;
    }
    get _f1_font() {
        var _a, _b;
        return typeof ((_a = this.config) === null || _a === void 0 ? void 0 : _a.f1_font) === 'undefined' ? false : (_b = this.config) === null || _b === void 0 ? void 0 : _b.f1_font;
    }
    get _dateLocale() {
        var _a;
        return ((_a = this.config) === null || _a === void 0 ? void 0 : _a.date_locale) || null;
    }
    get _imageClickable() {
        var _a, _b;
        return typeof ((_a = this.config) === null || _a === void 0 ? void 0 : _a.image_clickable) === 'undefined' ? false : (_b = this.config) === null || _b === void 0 ? void 0 : _b.image_clickable;
    }
    get _showCarnumber() {
        var _a, _b;
        return typeof ((_a = this.config) === null || _a === void 0 ? void 0 : _a.show_carnumber) === 'undefined' ? false : (_b = this.config) === null || _b === void 0 ? void 0 : _b.show_carnumber;
    }
    get _locationClickable() {
        var _a, _b;
        return typeof ((_a = this.config) === null || _a === void 0 ? void 0 : _a.location_clickable) === 'undefined' ? false : (_b = this.config) === null || _b === void 0 ? void 0 : _b.location_clickable;
    }
    get _previousRace() {
        var _a;
        return ((_a = this.config) === null || _a === void 0 ? void 0 : _a.previous_race) || undefined;
    }
    get _showRaceinfo() {
        var _a, _b;
        return typeof ((_a = this.config) === null || _a === void 0 ? void 0 : _a.show_raceinfo) === 'undefined' ? false : (_b = this.config) === null || _b === void 0 ? void 0 : _b.show_raceinfo;
    }
    get _hideTracklayout() {
        var _a, _b;
        return typeof ((_a = this.config) === null || _a === void 0 ? void 0 : _a.hide_tracklayout) === 'undefined' ? false : (_b = this.config) === null || _b === void 0 ? void 0 : _b.hide_tracklayout;
    }
    get _hideRacedatetimes() {
        var _a, _b;
        return typeof ((_a = this.config) === null || _a === void 0 ? void 0 : _a.hide_racedatetimes) === 'undefined' ? false : (_b = this.config) === null || _b === void 0 ? void 0 : _b.hide_racedatetimes;
    }
    get _showWeather() {
        var _a, _b;
        return typeof ((_a = this.config) === null || _a === void 0 ? void 0 : _a.show_weather) === 'undefined' ? false : (_b = this.config) === null || _b === void 0 ? void 0 : _b.show_weather;
    }
    get _rowLimit() {
        var _a;
        return ((_a = this.config) === null || _a === void 0 ? void 0 : _a.row_limit) || undefined;
    }
    generateCheckbox(configValue, label, checked) {
        return (0, lit_html_1.html) `
    ...
    render() {
        ...
        const cardTypes = [];
        for (const [key, value] of Object.entries(formulaone_card_types_1.FormulaOneCardType)) {
    ...
    _valueChangedSelect(ev) {
        ...
        if (configValue) {
            if (ev.detail.value.itemValue === '') {
                ...
                this.config = Object.assign(Object.assign({}, this.config), { [configValue]: itemValue });
            }
        }
        (0, custom_card_helpers_1.fireEvent)(this, 'config-changed', { config: this.config });
    }
    _valueChanged(ev) {
        if (!this.config || !this.hass) {
            return;
...
], FormulaOneCardEditor.prototype, "hass", void 0);
__decorate([
    (0, decorators_js_1.state)()
], FormulaOneCardEditor.prototype, "config", void 0);
...
const lit_1 = __webpack_require__(677);
const utils_1 = __webpack_require__(593);
const fonts_1 = __webpack_require__(169);
...
const schedule_1 = __webpack_require__(496);
const next_race_1 = __webpack_require__(249);
const last_result_1 = __webpack_require__(958);
const countdown_1 = __webpack_require__(765);
const results_1 = __webpack_require__(903);
const restcountry_client_1 = __webpack_require__(930);
const consts_1 = __webpack_require__(312);
...
/* harmony export */ });
/* harmony import */ var _directive_helpers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(232);
...
/* harmony import */ var _lit_html_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(692);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "UntilDirective": () => (/* binding */ h),
/* harmony export */   "until": () => (/* binding */ c)
/* harmony export */ });
/* harmony import */ var _lit_html_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(692);
/* harmony import */ var _directive_helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(232);
/* harmony import */ var _async_directive_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(206);
/* harmony import */ var _private_async_helpers_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(69);
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const n=t=>!(0,_directive_helpers_js__WEBPACK_IMPORTED_MODULE_1__/* .isPrimitive */ .pt)(t)&&"function"==typeof t.then;class h extends _async_directive_js__WEBPACK_IMPORTED_MODULE_2__/* .AsyncDirective */ .sR{constructor(){super(...arguments),this._$Cwt=1073741823,this._$Cyt=[],this._$CK=new _private_async_helpers_js__WEBPACK_IMPORTED_MODULE_4__/* .PseudoWeakRef */ .nX(this),this._$CX=new _private_async_helpers_js__WEBPACK_IMPORTED_MODULE_4__/* .Pauser */ .dS}render(...s){var i;return null!==(i=s.find((t=>!n(t))))&&void 0!==i?i:_lit_html_js__WEBPACK_IMPORTED_MODULE_0__.noChange}update(s,i){const r=this._$Cyt;let e=r.length;this._$Cyt=i;const o=this._$CK,h=this._$CX;this.isConnected||this.disconnected();for(let t=0;t<i.length&&!(t>this._$Cwt);t++){const s=i[t];if(!n(s))return this._$Cwt=t,s;t<e&&s===r[t]||(this._$Cwt=1073741823,e=0,Promise.resolve(s).then((async t=>{for(;h.get();)await h.get();const i=o.deref();if(void 0!==i){const r=i._$Cyt.indexOf(s);r>-1&&r<i._$Cwt&&(i._$Cwt=r,i.setValue(t))}})))}return _lit_html_js__WEBPACK_IMPORTED_MODULE_0__.noChange}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}const c=(0,_directive_js__WEBPACK_IMPORTED_MODULE_3__/* .directive */ .XM)(h);
...
var async_directive = __webpack_require__(206);
// EXTERNAL MODULE: ./node_modules/lit-html/directives/private-async-helpers.js
var private_async_helpers = __webpack_require__(69);
