...
class ErgastClient {
    ...
    GetSchedule(season) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return data === null || data === void 0 ? void 0 : data.MRData.RaceTable.Races;
        });
    }
    GetLastResult() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return data === null || data === void 0 ? void 0 : data.MRData.RaceTable.Races[0];
        });
    }
    GetDriverStandings() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return data === null || data === void 0 ? void 0 : data.MRData.StandingsTable.StandingsLists[0].DriverStandings;
        });
    }
    GetConstructorStandings() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return data === null || data === void 0 ? void 0 : data.MRData.StandingsTable.StandingsLists[0].ConstructorStandings;
        });
    }
    GetResults(season, round) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield this.GetData(`${season}/${round}/results.json`, false, 0);
            return data === null || data === void 0 ? void 0 : data.MRData.RaceTable;
        });
    }
    GetSeasons() {
        return __awaiter(this, void 0, void 0, function* () {
...
class LastResult extends base_card_1.BaseCard {
    ...
    render() {
        return (0, lit_html_1.html) `${(0, until_js_1.until)(this.client.GetLastResult().then(response => response
            ...
            : (0, lit_html_1.html) `${(0, utils_1.getApiErrorMessage)('last result')}`), (0, lit_html_1.html) `${(0, utils_1.getApiLoadingMessage)()}`)}`;
    }
}
...
class NextRace extends base_card_1.BaseCard {
    ...
    render() {
        return (0, lit_html_1.html) `${(0, until_js_1.until)(this.client.GetSchedule(new Date().getFullYear()).then(response => {
            ...
            const qualifyingDate = (0, format_date_time_1.formatDateTimeRaceInfo)(new Date(next_race.Qualifying.date + 'T' + next_race.Qualifying.time), this.hass.locale);
...
class Results extends base_card_1.BaseCard {
    ...
    setValues(values) {
        return __awaiter(this, void 0, void 0, function* () {
            this.races = yield this.extractValues(values);
        });
    }
    ...
    render() {
        ...
        return (0, lit_html_1.html) `   
            ...
            const seasons = response === null || response === void 0 ? void 0 : response.reverse();
            return seasons
                ? (0, lit_html_1.html) `<select name="selectedSeason" @change="${selectedSeasonChanged}">
                                            ${seasons.map(season => {
                    return (0, lit_html_1.html) `<option value="${season.season}">${season.season}</option>`;
                })}
                                        </select>`
                : (0, lit_html_1.html) `${(0, utils_1.getApiErrorMessage)('seasons')}`;
        }), (0, lit_html_1.html) `${(0, utils_1.getApiLoadingMessage)()}`)}                 
                    </td>
                    <td>
...
let FormulaOneCard = class FormulaOneCard extends lit_1.LitElement {
    ...
    shouldUpdate(changedProps) {
        return (0, utils_1.hasConfigOrEntitiesChanged)(this, changedProps);
    }
    set hass(hass) {
        this._hass = hass;
...
__decorate([
    (0, decorators_js_1.property)()
], FormulaOneCard.prototype, "cardValues", null);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getRefreshTime = exports.getEndOfSeasonMessage = exports.getApiLoadingMessage = exports.getApiErrorMessage = exports.getDriverName = exports.getCircuitName = exports.getCountryFlagUrl = exports.checkConfig = exports.getCountryFlagByName = exports.getCountryFlagByNationality = exports.hasConfigOrEntitiesChanged = void 0;
const lit_1 = __webpack_require__(392);
...
module.exports = JSON.parse('{"name":"formulaone-card","version":"0.3.5","description":"Frontend card for hass-formulaoneapi","main":"index.js","scripts":{"lint":"eslint src/**/*.ts","dev":"webpack -c webpack.config.js","build":"yarn lint && webpack -c webpack.config.js","test":"jest","coverage":"jest --coverage","workflow":"jest --coverage --json --outputFile=/home/runner/work/formulaone-card/formulaone-card/jest.results.json","prebuild":"copy git-hooks\\\\pre-commit .git\\\\hooks\\\\ && echo \'hook copied\'"},"repository":{"type":"git","url":"git+https://github.com/marcokreeft87/formulaone-card.git"},"keywords":[],"author":"","license":"ISC","bugs":{"url":"https://github.com/marcokreeft87/formulaone-card/issues"},"homepage":"https://github.com/marcokreeft87/formulaone-card#readme","devDependencies":{"@types/jest":"^29.2.5","@typescript-eslint/eslint-plugin":"^5.48.1","@typescript-eslint/parser":"^5.48.1","codecov":"^3.8.3","eslint":"^8.24.0","home-assistant-js-websocket":"^8.0.0","lit":"^2.3.1","typescript":"^4.8.4","webpack":"^5.75.0","webpack-cli":"^4.10.0"},"dependencies":{"@babel/plugin-transform-runtime":"^7.19.6","@babel/preset-env":"^7.20.2","@lit-labs/scoped-registry-mixin":"^1.0.1","axios":"^1.2.2","babel-jest":"^29.3.1","compression-webpack-plugin":"^10.0.0","custom-card-helpers":"^1.9.0","jest-environment-jsdom":"^29.3.1","jest-ts-auto-mock":"^2.1.0","ts-auto-mock":"^3.6.4","ts-jest":"^29.0.3","ts-loader":"^9.4.1","ttypescript":"^1.5.15","yarn":"^1.22.19"}}');
