    ...
    renderStandingRow(standing: ConstructorStanding): HTMLTemplateResult {
        return html`
            <tr>
                ...
                <td>${(this.config.standings?.show_teamlogo ? html`<img height="10" width="20" src="${getTeamImageUrl(standing.Constructor.constructorId)}">&nbsp;` : '')}${standing.Constructor.name}</td>
