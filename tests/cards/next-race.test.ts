...
describe('Testing next-race file', () => {
    ...
    test('Calling renderHeader with hass and wrong sensor', () => { 
        ...
        expect(htmlResult).toMatch('<h2><img height="25" src="https://flagcdn.com/w40/bahrain.png">&nbsp; 1 : Bahrain Grand Prix</h2><img width="100%" src="https://www.formula1.com/content/dam/fom-website/2018-redesign-assets/Circuit%20maps%2016x9/Bahrain_Circuit.png.transform/7col/image.png"><br>');
    }),
