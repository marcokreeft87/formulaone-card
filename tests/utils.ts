...
export const getRenderStringAsync = async (data: HTMLTemplateResult, origin?: string) : Promise<string> => {
        ...
        if(typeof values[i] === 'string') {
            ...
            if(templates !== undefined) {
                ...
                for(let j = 0; j < templates.length; j++) {
                    returnHtml += await getRenderStringAsync(templates[j], 'tempaltes');
                }
            }      
            ...
            for(let j = 0; j < templateResult.values.length; j++) {
                if(templateResult.values[j] instanceof Promise<HTMLTemplateResult>) {
                    ...
                    returnHtml += await getRenderStringAsync(promiseResult, 'instanceof');
                    ...
                    returnHtml += await getRenderStringAsync(templateResult, undefined);
                }
            }
